    ...
    <div>
      <div className="mb-12 text-center">
        <div className="inline-flex items-center space-x-3 mb-4">
          ...
          <h1 className="text-4xl font-bold text-white">How GambitAI Works</h1>
        </div>
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700 mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">What is Arbitrage?</h2>
      ...
      <div className="space-y-6 mb-12">
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-semibold text-white mb-2">1. Market Monitoring</h3>
            <p className="text-gray-300">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-semibold text-white mb-2">2. Arbitrage Detection</h3>
            <p className="text-gray-300">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-semibold text-white mb-2">3. Instant Alerts</h3>
            <p className="text-gray-300">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-semibold text-white mb-2">4. Take Action</h3>
            <p className="text-gray-300">
      ...
      <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-xl p-8 border border-blue-500/30 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Multi-Category Coverage</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Smart Calculations</h3>
