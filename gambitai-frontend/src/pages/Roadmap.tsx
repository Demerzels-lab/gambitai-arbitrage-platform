  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-400">Our vision for the future of GambitAI</p>
      </div>
        ...
        {milestones.map((milestone, index) => (
          ...
          >
            ...
            <div className="flex items-start space-x-4">
              {/* Status Icon */}
              <div className="flex-shrink-0 z-10 bg-gray-800 p-1">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <div className="flex items-center space-x-3 mb-2">
                      <h2 className="text-2xl font-bold text-white">{milestone.version}</h2>
                      <span
                    ...
                    <h3 className="text-lg text-gray-300 font-semibold">{milestone.title}</h3>
                  </div>
      ...
      {/* Community Feedback */}
      <div className="mt-8 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-xl p-6 border border-blue-500/30">
        <h2 className="text-xl font-bold text-white mb-2">Have a Feature Request?</h2>
