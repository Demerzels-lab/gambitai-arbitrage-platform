      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-teal-900/50 backdrop-blur-sm rounded-xl p-6 border border-teal-700">
          <div className="flex items-center space-x-2 mb-6">
            <CalcIcon className="w-6 h-6 text-teal-400" />
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-teal-500 to-teal-700 hover:from-teal-600 hover:to-teal-700 text-white font-medium py-3 rounded-lg transition-all shadow-lg"
            >
              Calculate
            </button>
          </div>
        ...
        <div className="bg-teal-900/50 backdrop-blur-sm rounded-xl p-6 border border-teal-700">
          ...
          {!result ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-teal-950/50 rounded-lg">
                ...
                <div className="pt-4 border-t border-teal-700">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center justify-between p-3 bg-teal-400/10 rounded">
                    ...
                    <div className="flex items-center justify-between p-3 bg-teal-600/10 rounded">
